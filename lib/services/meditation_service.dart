      ...
      if (allMeditations != null && allMeditations is List) {
        return allMeditations.map((item) {
          if (item is Map<String, dynamic>) {
            return MeditationExercise.fromJson(item);
          } else {
            return MeditationExercise.fromJson(Map<String, dynamic>.from(item));
          }
        }).toList();
      } else {
        return [];
    ...
    try {
      ...
      if (allMeditations != null && allMeditations is List) {
        ...
        meditationList.removeWhere((item) {
          MeditationExercise currentMeditation =
              MeditationExercise.fromJson(Map<String, dynamic>.from(item));
